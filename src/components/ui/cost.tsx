...
export const Cost = () => {
  return (
    <section className="flex w-full justify-center">
      <article className="flex w-full max-w-5xl flex-col gap-16 px-2">
        <h2 className="text-3xl font-bold underline underline-offset-2 sm:text-4xl">
        ...
        <div className="flex flex-col gap-10 sm:gap-16">
          ...
          <div className="m-auto flex w-full flex-col items-center justify-center gap-y-7 px-10">
