...
export const CardImage = () => {
  return (
    ...
    >
      <div className="absolute bottom-0 aspect-square w-[130%] max-w-[1400px] translate-y-[75%] rounded-full bg-[radial-gradient(circle,_#828B98_0%,_transparent_90%)] blur-xl min-[400px]:translate-y-[55%] sm:translate-y-[60%] lg:translate-y-[80%]" />
