          ...
          <ul className="m-auto grid grid-cols-1 content-center gap-5 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
            {cards.map((card, index) => (
              <li key={index} className="h-full max-w-md">
                <Card className="h-full rounded-2xl border border-white/10 bg-white/[0.03] py-2 text-foreground transition-all duration-300 hover:border-popover-foreground/20 hover:bg-white/[0.045]">
